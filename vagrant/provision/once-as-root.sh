...
apt-get install -y php7.1-curl php7.1-cli php7.1-intl php7.1-mysqlnd php7.1-gd php7.1-fpm php7.1-mbstring php7.1-xml unzip nginx mariadb-server-10.0 php.xdebug
...
mysql -uroot <<< "CREATE DATABASE store"
mysql -uroot <<< "CREATE DATABASE store_test"
echo "Done!"
